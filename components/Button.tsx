...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-[#CB844E] text-white hover:bg-[#B67341] shadow-lg shadow-orange-100',
    secondary: 'bg-black text-white hover:bg-gray-800',
    outline: 'border-2 border-gray-200 bg-transparent hover:border-[#CB844E] hover:text-[#CB844E]',
